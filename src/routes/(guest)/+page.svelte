<script lang="ts">
	...
	import { Diets, Locomotions, Dinosaurs, DinosaurImages, Clades, dinoMeme } from '$lib/data/images.js';
	import { loadMoreDinos } from '$lib/api/dinosaur';
	import type { imageInfo,Benefit } from '$lib/types/clades';
	...
	let itsbenefit: Benefit[] = [
		{ label: 'Clades', image: Clades },
		{ label: 'Diets', image: Diets },
		{ label: 'Locomotions', image: Locomotions },
		{ label: 'Dinosaurs', image: Dinosaurs },
		{ label: 'Images', image: DinosaurImages }
	];
